...
src=open(os.path.join(base,"host/python/gates/product.py")).read()  # noqa: SIM115
# product calls run() at module level
exec(compile(src, "product.py", "exec"), {"__name__":"__main__","__file__":"product.py"})  # noqa: S102
