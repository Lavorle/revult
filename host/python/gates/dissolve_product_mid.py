...
# ----------------------------------------------------------------------
# Migration path for dissolve_product_mid:
...
#            # case: dict with {"amount": 0.5, "transitions": 2}
...
#            return compare_or_bootstrap("dissolve_product_mid", w, h, rgba)
...
#            @parametrized_gate("dissolve_product_mid", [{"amount": 0.5, "transitions": 2}])
...
#                cases = [{"amount": 0.5, "transitions": 2}]
#                ok = gate_harness("dissolve_product_mid", cases, _harness_run_one, _harness_golden_compare)
...
#            _harness_main()
#
# Notes: preserve TRANSITIONS_PREF=2 invariant; cases sweep dissolve amount while asserting transitions_pref never forced 0. Reuse _scene_render / _solid_rgba / _mean_rgb helpers.
